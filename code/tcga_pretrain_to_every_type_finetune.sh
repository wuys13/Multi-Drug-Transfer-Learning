...
python -u 0_TT_ft_hyper_main.py --souce_num 0       # tcga pretrain
            --target_num ${SLURM_ARRAY_TASK_ID} \   # pretrain选择哪几个癌种
            --select_drug_method overlap \           # 
            --store_dir tcga_pretrain #匹配select_drug_method，存那里
