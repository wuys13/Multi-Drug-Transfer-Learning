...
def train_dsrn_mmd(s_dataloaders, t_dataloaders, **kwargs):
    """
    ...
    if kwargs['retrain_flag']:
        ...
        for epoch in range(int(kwargs['train_num_epochs'])):
            ...
            for step, s_batch in enumerate(s_train_dataloader):
                ...
                dsnae_train_history = dsn_ae_train_step(s_dsnae=s_dsnae, #loss = s_loss_dict['loss'] + t_loss_dict['loss'] + m_loss
                                                        t_dsnae=t_dsnae,
                                                        s_batch=s_batch,
                                                        t_batch=t_batch,
                                                        device=device,
